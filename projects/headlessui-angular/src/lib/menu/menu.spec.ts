...
describe('MenuTestComponent', () => {
  ...
  function arrowDown(debugElement: DebugElement) {
    debugElement.nativeElement.dispatchEvent(new KeyboardEvent('keydown', { key: 'ArrowDown' }))
  }

  function arrowUp(debugElement: DebugElement) {
    debugElement.nativeElement.dispatchEvent(new KeyboardEvent('keydown', { key: 'ArrowUp' }))
  }

  function escape(debugElement: DebugElement) {
    debugElement.nativeElement.dispatchEvent(new KeyboardEvent('keydown', { key: 'Escape' }))
  }
